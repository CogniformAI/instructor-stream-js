...
<Aside type="note" title="Why Schema.typeSchema is used">
  ...
  [Schema.typeSchema](/docs/schema/projections/#typeschema). This is because the decoding/encoding
  of the elements is already handled by the `from` schema: `Schema.Array(itemSchema)`, avoiding
  double decoding.
</Aside>
...
While the [Schema.transform](#transform) function is suitable for error-free transformations, the `Schema.transformOrFail` function is designed for more complex scenarios where **transformations can fail** during the decoding or encoding stages.
...
<Aside type="tip" title="Lowercase And Lowercased">
  ...
  `Schema.Lowercased` schema or the `Schema.lowercased` filter.
</Aside>
...
<Aside type="tip" title="Uppercase And Uppercased">
  ...
  `Schema.Uppercased` schema or the `Schema.uppercased` filter.
</Aside>
...
<Aside type="tip" title="Capitalize And Capitalized">
  ...
  `Schema.Capitalized` schema or the `Schema.capitalized` filter.
</Aside>
...
<Aside type="tip" title="Uncapitalize And Uncapitalized">
  ...
  `Schema.Uncapitalized` schema or the `Schema.uncapitalized` filter.
</Aside>
